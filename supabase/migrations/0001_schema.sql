-- ══════════════════════════════════════════════════════════════
-- [설계도] 데이터를 담을 표 만들기
-- 상품·회원·장바구니·주문을 담을 표 8개를 만든다. 엑셀 시트 8장을 만드는 것과 같다.
-- 표 안에 '가격은 0 이상', '수량은 1 이상' 같은 규칙을 박아 넣는다.
--   코드가 실수해도 이상한 값은 저장되지 않는다.
-- 회원가입이 일어나면 자동으로 회원 정보 줄을 만드는 장치도 여기 있다.
-- ★ orders 표에 '총액'과 '상태' 칸이 없다. 일부러 뺐다 — 이유는 아래 0002 파일과 관련 있다.
-- ══════════════════════════════════════════════════════════════
